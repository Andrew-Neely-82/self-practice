...
class Program {
 static void Main(string[] args) {
  ...
  print("\n\nbyte: " + numByte + "\nshort: " + numShort + "\nint: " + numInt + "\nchar: " + charA + "\nstring: " + myString + "\nobject string: " 
  + myObjectString + "\nobject num: " + myObjectNum + "\nobject boolean: " + myObjectBoolean + "\ndynamic string: " + myDynamicString + 
  "\ndynamic num: " + myDynamicNum + "\ndynamic boolean: " + myDynamicBoolean + "\nvar string: " + myVarString + "\nvar num: " + myVarNum);
